...
Java_io_kitsuri_mayape_util_Logger_nativeCreateLogger(JNIEnv *env,
                                                          jobject thiz,
                                                          jstring name) {
...
Java_io_kitsuri_mayape_util_Logger_nativeDestroyLogger(
...
extern "C" JNIEXPORT void JNICALL
Java_io_kitsuri_mayape_util_Logger_nativeInfo(JNIEnv *env, jobject thiz,
...
extern "C" JNIEXPORT void JNICALL
Java_io_kitsuri_mayape_util_Logger_nativeError(JNIEnv *env, jobject thiz,
                                                   jlong native_logger_ptr,
                                                   jstring msg) {
  auto *logger = reinterpret_cast<Logger *>(native_logger_ptr);
  const char *nativeMsg = env->GetStringUTFChars(msg, nullptr);
...
extern "C" JNIEXPORT void JNICALL
Java_io_kitsuri_mayape_util_Logger_nativeWarn(JNIEnv *env, jobject thiz,
                                                  jlong native_logger_ptr,
                                                  jstring msg) {
  auto *logger = reinterpret_cast<Logger *>(native_logger_ptr);
  const char *nativeMsg = env->GetStringUTFChars(msg, nullptr);
...
extern "C" JNIEXPORT void JNICALL
Java_io_kitsuri_mayape_util_Logger_nativeDebug(JNIEnv *env, jobject thiz,
                                                   jlong native_logger_ptr,
                                                   jstring msg) {
  auto *logger = reinterpret_cast<Logger *>(native_logger_ptr);
  const char *nativeMsg = env->GetStringUTFChars(msg, nullptr);
